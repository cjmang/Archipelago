...
events = [
    ...
    #Todo event flags
    InternalLocationData(9999, 9999, 5101, 5101, [0], 0,
        5101, True, True, LocationType.Event, LocationRestriction(7), True), # Kandorean Temple - Master's Room
    InternalLocationData(9999, 9999, 5102, 5102, [0], 0,
        5102, True, True, LocationType.Event, LocationRestriction(7), True), # Madra Catacombs - MainRuins Area Pushable Log
    InternalLocationData(9999, 9999, 5103, 5103, [0], 0,
        5103, True, True, LocationType.Event, LocationRestriction(7), True), # Madra Catacombs - West Bedroom Item On Shelf
