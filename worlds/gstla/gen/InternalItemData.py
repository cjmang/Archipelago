...
events: List[InternalEventItemData] = [
    ...
    InternalEventItemData(5101, 9999, "Kandorean Temple - Master's Room", "Kandorean Temple - Clear Kandorean Temple"),
    InternalEventItemData(5102, 9999, "Madra Catacombs - MainRuins Area Pushable Log", "Madra Catacombs Main Ruins - Log Pushed"),
    InternalEventItemData(5103, 9999, "Madra Catacombs - West Bedroom Item On Shelf", "Madra Catacombs West Bedroom - Tremored Item Down"),
